...
class Lupo3D_GunFireSmoke: Actor
{
    Default
	{
        Alpha 0.75;
...
class Lupo3D_Smoke : Actor abstract
{
	...
	Default
	{
		Lupo3D_Smoke.GrowSpeed 0.00275, 0.003;
		Lupo3D_Smoke.FadeSpeed 0.00275, 0.003;
		Lupo3D_Smoke.StopSpeed 0.95, 0.95;
		Lupo3D_Smoke.GrowStopFactor 0.98;
		Radius 5;
		Height 10;
		Scale 0.02;
		Gravity 0.022;
...
class Lupo3D_ExplosionSmoke : Lupo3D_Smoke
{
	Default
	{
		Scale 0.4;
		Lupo3D_Smoke.FadeSpeed 0.003, 0.007;
		Lupo3D_Smoke.GrowSpeed 0.006, 0.010;
		Lupo3D_Smoke.StopSpeed 0.80, 0.88;
	}
